...
@SuppressLint("SdCardPath") public class Law_four extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.law_four);
		ListView listView = (ListView) findViewById(R.id.listViewlaw);
		caliingDpCopy();
		getContent();
	...
	private void getContent() {
		...
		String sql = "SELECT info_four FROM four";
		...
		for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
			...
			dbList.add(c.getString(c.getColumnIndex("info_four")));
		}
