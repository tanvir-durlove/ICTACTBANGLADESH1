...
@SuppressLint("SdCardPath") public class Law_five extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.law_five);
		ListView listView = (ListView) findViewById(R.id.listViewfive);
		caliingDpCopy();
		getContent();
	...
	private void getContent() {
		...
		String sql = "SELECT info_five FROM five";
		...
		for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
			...
			dbList.add(c.getString(c.getColumnIndex("info_five")));
		}
