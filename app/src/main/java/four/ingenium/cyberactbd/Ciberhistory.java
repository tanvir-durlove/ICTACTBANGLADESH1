...
@SuppressLint("SdCardPath") public class Ciberhistory extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ciberhistory);
	...
	private void getContent() {
		...
		String sql = "SELECT info_history FROM history";
		...
		for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
			...
			dbList.add(c.getString(c.getColumnIndex("info_history")));
		}
