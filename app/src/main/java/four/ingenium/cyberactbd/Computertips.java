...
@SuppressLint("SdCardPath") public class Computertips extends ActionBarActivity {
	ListView listView;
	ArrayList<String>dbList=new ArrayList<String>();
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.computertips);
	...
	private void getContent() {
		...
		String sql = "SELECT info_computer FROM computer";
		...
		for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
			...
			dbList.add(c.getString(c.getColumnIndex("info_computer")));
		}
