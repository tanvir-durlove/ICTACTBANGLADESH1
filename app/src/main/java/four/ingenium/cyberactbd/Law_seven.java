...
@SuppressLint("SdCardPath") public class Law_seven extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.law_seven);
		ListView listView = (ListView) findViewById(R.id.listViewseven);
		caliingDpCopy();
		getContent();
	...
	private void getContent() {
		...
		String sql = "SELECT info_seven FROM seven";
		...
		for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
			...
			dbList.add(c.getString(c.getColumnIndex("info_seven")));
		}
