...
public class Mobiletips extends ActionBarActivity {
	ListView listView;
	ArrayList<String>dbList=new ArrayList<String>();
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.mobiletips);
	...
	@SuppressLint("SdCardPath") private void getContent() {
		...
		String sql = "SELECT info_mobile FROM mobile";
		...
		for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
			...
			dbList.add(c.getString(c.getColumnIndex("info_mobile")));
		}
