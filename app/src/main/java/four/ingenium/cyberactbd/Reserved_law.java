...
public class Reserved_law extends ActionBarActivity {
	ListView listView;
	ArrayList<String>dbList=new ArrayList<String>();
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.reserved_law);
	...
	@SuppressLint("SdCardPath") private void getContent() {
		...
		String sql = "SELECT info_modify FROM modify";
		...
		for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
			...
			dbList.add(c.getString(c.getColumnIndex("info_modify")));
		}
