...
@SuppressLint("SdCardPath") public class Law_eight extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.law_eight);
	
		ListView listView = (ListView) findViewById(R.id.listVieweight);
		caliingDpCopy();
		getContent();
	...
	private void getContent() {
		...
		String sql = "SELECT info_eight FROM eight";
		...
		for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
			...
			dbList.add(c.getString(c.getColumnIndex("info_eight")));
		}
