...
public class Tribunal extends ActionBarActivity {
	ListView listView;
	ArrayList<String>dbList=new ArrayList<String>();
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.tribunal);
	...
	@SuppressLint("SdCardPath") private void getContent() {
		...
		String sql = "SELECT info_tribunal FROM tribunal";
		...
		for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
			...
			dbList.add(c.getString(c.getColumnIndex("info_tribunal")));
		}
