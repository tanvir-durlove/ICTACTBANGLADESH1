...
@SuppressLint("SdCardPath") public class Law_nine extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.law_nine);
		ListView listView = (ListView) findViewById(R.id.listViewnine);
		caliingDpCopy();
		getContent();
	...
	private void getContent() {
		...
		String sql = "SELECT info_nine FROM nine";
		...
		for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
			...
			dbList.add(c.getString(c.getColumnIndex("info_nine")));
		}
